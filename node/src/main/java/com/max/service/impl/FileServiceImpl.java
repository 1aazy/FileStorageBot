...
import com.max.dao.AppDocumentDAO;
import com.max.dao.AppPhotoDAO;
import com.max.dao.BinaryContentDAO;
import com.max.entity.AppDocument;
import com.max.entity.BinaryContent;
import com.max.exceptions.UploadFileException;
...
import com.max.service.FileService;
...
public class FileServiceImpl implements FileService {
    ...
    private BinaryContent getPersistentBinaryContent(ResponseEntity<String> response) {
        ...
        byte[] fileInByte = donwloadFile(filePath);
    ...
    private AppDocument buildTransientAppDoc(Document telegramDoc, BinaryContent persisntentBinaryContent) {
        return AppDocument.builder()
                        .telegramFileId(telegramDoc.getFileId())
                        .docName(telegramDoc.getFileName())
                        .binaryContent(persisntentBinaryContent)
    ...
    private byte[] donwloadFile(String filePath) {
    ...
    public String generateLink(Long docId, LinkType linkType) {
        ...
        return linkAdress + "/" + linkType + "?id=" + hash;
    }
}
